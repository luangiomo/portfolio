    ...
    <div className="w-full lg:w-10/12  py-6 border-b border-b-white/10">
      <div className="grid grid-cols-2 gap-3">
        <div className="flex flex-col justify-between">
          <h2 className="leading-tight font-mono font-semibold uppercase text-base  text-white tracking-tight whitespace-nowrap mb-3">
            Vamos conversar!
          </h2>
          <p className="leading-tight font-sans text-white/60 text-sm pr-8 hidden sm:block">
            ...
            Sinta-se a vontade para entrar em contado e contar um pouco mais
        ...
        <div className="">
          <form className="flex flex-col items-end gap-2">
            ...
            {/* <button className="p-2 py-1 rounded-lg bg-white text-black font-sans font-semibold uppercase text-xs">
                        Enviar mensagem!
                      </button> */}
          </form>
        </div>
